...
//              内容区填充数据
                ...
                arr.forEach(function(val){  //传参数调用数组中的数据
                    str+='<div><div id="check"><input type="checkbox" /></div><div id = "er1">'+val.count+'</div><div id = "er2">('+val.id+'</div><img src="val.ur+img" id = "er3"/><img src="val.ur+imgs" id = "er4"/><div id = "er5">'+val.ti+')</div><br/><br/><br/><div id = "er6">'+val.tnum+'</div><div id = "er7">'+val.key7+'</div><div id = "er8">'+val.key8+'</div><div id = "er9">'+val.key9+'</div><br/><br/><div id = "er10">'+val.key10+'</div><div id = "er11">'+val.key11+'</div><div id = "er12">'+val.key12+'</div><div id = "er13">更新时间：'+val.key13+'</div><div id = "er14">查看联系方式</div><div id = "er15">|&nbsp;&nbsp;免费沟通</div></div>';
                }); 

...
//              内容区填充数据
                ...
                arr.forEach(function(value){  //传参数调用数组中的数据
                    str+='<div id = "er1" class="movie">'+value.key1+'</div><div id = "er2" class="movie">'+value.key2+'</div><div id = "er3" class="movie">'+value.key3+'</div><div id = "er4" class="movie">'+value.key4+'</div><div id = "er5" class="movie">'+value.key5+'</div><div id = "er6" class="movie">'+value.key6+'</div><div id = "er7" class="movie">'+value.key7+'</div><div id = "er8" class="movie">'+value.key8+'</div><div id = "er9" class="movie">'+value.key9+'</div><div id = "er10" class="movie">'+value.key10+'</div><div id = "er11" class="movie">'+value.key11+'</div><div id = "er12" class="movie">'+value.key12+'</div>'
                }); 

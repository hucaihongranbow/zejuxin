    ...
    function paginationNick(opt){
		...
		function goPage(btn){	
            ...
            function defaul (){//页面加载时请求的数据            	
            	urls="http://juhuituan.boguyuan.com/juhuituan/reqData?action=listCate&acode=1&uid=22285&type=1";
            }
        	defaul();//页面加载时调用
        	...
        	$("#job").click(function  () {//职前培训的数据
        		urls="http://juhuituan.boguyuan.com/juhuituan/reqData?action=ordPro&acode=1&uid=22285&id=12&ord=0";
        		request ()
        	})
        	
        	$("#sel").click(function  () {//就业选择的数据
        		urls="http://juhuituan.boguyuan.com/juhuituan/reqData?action=listCate&acode=1&uid=22285&type=1";
        		request ()
        	})
        	
        	$("#sell").click(function  () {//销售技能的数据
        		urls="http://juhuituan.boguyuan.com/juhuituan/reqData?action=ordPro&acode=1&uid=22285&id=12&ord=0";
        		request ()
        	})
			...
			//                设置当前页码
			               ...
			               function fist (pid) {
			                ...
			                arr.forEach(function(val){  //传参数调用数组中的数据
			                    str+='<div class="movie"><img src="val.ur+imgs" id = "er4"/> <div class="jianjie">'+val.ti+'</div> <div class="shichang">'+val.id+'</div> </div>';
			                }); 

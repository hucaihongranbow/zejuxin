$(document).ready(function  () {
    ...
    $.ajax({
    	type:"get",
    	url:"http://192.168.2.151:8080/huajiayi/vmenu/findAll.do",//请求左侧菜单数据
    	datatype:"json",
...
//  		alert("菜单")
    		...
    		$('.menu').click(function(){
					...
					alert(getid)
    				window.location.href="careers_guide.html?id="+getid;
    				//调用
				    defaul();
				    request ()
    			})
...
//	       console.log(urld);
            ...
            function defaul (){//页面加载时请求的数据   
            	urld="http://192.168.2.151:8080/huajiayi/video/findAll.do?id="+str1[1];
            }
        	defaul();//页面加载时调用
        	request ()//页面加载时调用
...
//      	默认排序
        	$("#default").click(function () {
        		urld="http://192.168.2.151:8080/huajiayi/video/descByGrade.do";
    				request ()
        	})
        	
//      	按时间排序
        	$("#time").click(function () {
        		urld="http://192.168.2.151:8080/huajiayi/video/descTime.do";
    				request ()
        	})

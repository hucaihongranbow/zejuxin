...
//              内容区填充数据
                ...
                arr.forEach(function(value){  //传参数调用数组中的数据
                    str+='<div><div id = "er"><div id = "er1">'+value.key1+'</div><div id = "er2">'+value.key2+'</div><br/><br/><div id = "er3">'+value.key3+'</div><div id = "er4">'+value.key4+'</div><br/><br/><div id = "er5">'+value.key5+'</div><div id = "er6">'+value.key6+'</div><div id = "er7">'+value.key7+'</div></div>   <div id = "ers"><div id = "er8">'+value.key8+'</div><br/><br/><br/><br/><div id = "er9">'+value.key9+'</div><div id = "er10">'+value.key10+'</div><div id = "er11">'+value.key11+'</div><div id = "er12">'+value.key12+'</div></div></div>';
                }); 
